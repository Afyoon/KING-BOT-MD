...
module.exports = {
    ...
    OWN_NAME: process.env.OWNER_NAME === undefined ? 'ＡＦＹＯＯＮ 縁う園' : process.env.OWN_NAME,
    BOT_NAME: process.env.BOT_NAME === undefined ? '[✦卂千ㄚㄖㄖ几 ⽕⼺] - Unknown' : process.env.BOT_NAME,
    ST_PKG: process.env.STICKER_PACKAGE === undefined ? '9162888139' : process.env.ST_PKG,
